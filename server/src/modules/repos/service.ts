...
export class RepoService {
  /**
   * The three capabilities this use case actually needs, named in the
   * signature. Previously it took the whole DI container, which hid them and
   * created a service → container → service cycle.
   */
  constructor(
