 ...
 * They are pure functions now, so each rule gets a direct test — including the
 * two that have already caused real bugs (see INSIGHTS.md): the round-vs-latest
 * split, and cost `null` never rendering as $0.00.
 */
