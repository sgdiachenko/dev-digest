...
| `08-skills` | `/skills` → seeded skill renders → Config → Preview → Stats → Versions tabs render |
| `09-conventions` | `/conventions` → seeded accepted/config-derived/rejected candidates + scan summary + Create-skill action render |
